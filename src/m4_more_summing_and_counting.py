...
def run_test_count_cosines_from():
    ...
    expected = 5
    answer = count_cosines_from(5, 14, 0.24)
    ...
    expected = 10
    answer = count_cosines_from(2, 30, 0.3)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(10, 14, 0.12)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(12, 18, 0.45)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 1.283333  # This is APPROXIMATELY the correct answer.
