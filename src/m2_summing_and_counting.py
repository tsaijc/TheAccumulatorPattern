...
def run_test_sum_more_cosines():
    ...
    expected = 0.24243  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-5, 7)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 1.56857  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(6, 8)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
...
def run_test_count_sines_vs_cosines():
    ...
    expected = 86
    answer = count_sines_vs_cosines(85)
